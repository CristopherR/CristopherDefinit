...
class VendedorsControllerTest < ActionController::TestCase
  ...
  test "should create vendedor" do
    assert_difference('Vendedor.count') do
      post :create, vendedor: { apellidoV: @vendedor.apellidoV, cod_vendedor: @vendedor.cod_vendedor, direccionV: @vendedor.direccionV, nombreV: @vendedor.nombreV }
    end
  ...
  test "should update vendedor" do
    patch :update, id: @vendedor, vendedor: { apellidoV: @vendedor.apellidoV, cod_vendedor: @vendedor.cod_vendedor, direccionV: @vendedor.direccionV, nombreV: @vendedor.nombreV }
    assert_redirected_to vendedor_path(assigns(:vendedor))
  end
