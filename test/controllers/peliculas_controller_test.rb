...
class PeliculasControllerTest < ActionController::TestCase
  ...
  test "should create pelicula" do
    assert_difference('Pelicula.count') do
      post :create, pelicula: { ano: @pelicula.ano, categoria: @pelicula.categoria, cod_pel: @pelicula.cod_pel, titulo: @pelicula.titulo }
    end
  ...
  test "should update pelicula" do
    patch :update, id: @pelicula, pelicula: { ano: @pelicula.ano, categoria: @pelicula.categoria, cod_pel: @pelicula.cod_pel, titulo: @pelicula.titulo }
    assert_redirected_to pelicula_path(assigns(:pelicula))
  end
